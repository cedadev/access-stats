...
class FilterForm(forms.Form):
    start = forms.DateField(widget=DatePickerInput(format="%Y/%m/%d"),label='Start date:', required=False, input_formats=["%Y/%m/%d"])
    end = forms.DateField(widget=DatePickerInput(format="%Y/%m/%d"),label='End date:', required=False, input_formats=["%Y/%m/%d"])
